...
- Для записи и экспорта использовать общий путь `pdf_file_state`: снимок исходника, проверка версии и публикация под блокировками. Сохранять ввод при конфликте; ограничение сторонних писателей и порядок продолжения описаны в README, раздел «Сохранение при параллельных правках».
